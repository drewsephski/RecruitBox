...
const RecruitmentSandbox: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-auto min-h-[700px] lg:h-[600px] w-full max-w-full bg-[#080808] rounded-xl border border-white/10 overflow-hidden shadow-2xl transition-all duration-500 group relative z-10">
      {/* Toolbar / Header */}
